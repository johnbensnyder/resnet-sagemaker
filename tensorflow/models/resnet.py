...
def ResNet152V1_b(include_top=True,
              weights=None,
              input_shape=None,
              pooling=None,
              classes=1000,
...
def ResNet152V1_c(include_top=True,
              weights=None,
              input_shape=None,
              pooling=None,
              classes=1000,
...
def ResNet152V1_d(include_top=True,
              weights=None,
              input_shape=None,
              pooling=None,
              classes=1000,
    ...
    def stack_fn(x):
        x = stack1(x, 64, 3, stride1=1, avg_down=True, name='conv2', weight_decay=weight_decay)
        x = stack1(x, 128, 8, avg_down=True, name='conv3', weight_decay=weight_decay)
        x = stack1(x, 256, 36, avg_down=True, name='conv4', weight_decay=weight_decay)
        x = stack1(x, 512, 3, avg_down=True, name='conv5', weight_decay=weight_decay)
        return x
    return ResNet(stack_fn, False, True, 'resnet101v1_d',
                  include_top, weights,
